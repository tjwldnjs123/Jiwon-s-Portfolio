...
const chartData = [
  ...
  },
  {
    ...
    성장률: 80,
    description:
      "그린아이티코리아와 모빌테크에서의 실무 경험을 통해 기술적 깊이와 시스템 통합 역량을 지속적으로 확장하고 있습니다. Node.js 기반 장치 연동, GeoServer 기반 지도 서비스 구축, 설치형 통합 보안 솔루션 개발 등 다양한 프로젝트를 수행하며 실무에 적용해 왔습니다. 특히 지도 기반 서비스와 실시간 데이터 처리 시스템을 구축하는 과정에서 React 기반 프론트엔드와 Node.js 백엔드를 통합한 풀스택 개발 경험을 쌓았으며, 서비스 설계부터 배포까지 전체 개발 프로세스를 경험하며 개발자로서 한 단계 성장하고 있습니다."
  }
];
